    ...
    fun generateDummyMovie(): List<MovieEntity> {
        ...
        movies.add(
            MovieEntity(
                ...
                "T-34",
                "2018",
                listOf("War", "Action", "Drama", "History"),
                "2h 19m",
                "54",
        ...
        movies.add(
            MovieEntity(
                ...
                "2018",
                listOf("Action", "Adventure", "Science Fiction", "Comedy"),
                "1h 57m",
                "84",
    ...
    fun generateRemoteDummyTvShow(): List<TvShowResponse> {
        ...
        tvShows.add(
            TvShowResponse(
                ...
                "2019",
                listOf("Action & Adventure", "Sci-Fi & Fantasy", "Drama"),
                "55m",
                "87",
        ...
        tvShows.add(
            TvShowResponse(
                ...
                "The Simpsons",
                "1989",
                listOf("Animation", "Comedy", "Family", "Drama"),
                "22m",
                "78",
        ...
        tvShows.add(
            TvShowResponse(
                ...
                "Game of Thrones",
                "2011",
                listOf("Sci-Fi & Fantasy", "Drama", "Action & Adventure", "Mystery"),
                "1h",
                "84",
        ...
        tvShows.add(
            TvShowResponse(
                ...
                "Fairy Tail",
                "2009",
                listOf("Action & Adventure", "Animation", "Comedy", "Sci-Fi & Fantasy"),
                "25m",
                "76",
        ...
        tvShows.add(
            TvShowResponse(
                ...
                "Dragon Ball",
                "1989",
                listOf("Comedy", "Sci-Fi & Fantasy", "Animation", "Action & Adventure"),
                "25m",
                "80",
